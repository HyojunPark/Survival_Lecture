...
First, set the working folder to access datasets.
...
```{r}
load("~/pCloudDrive/Git/Survival/AddHealth/ICPSR_21600/DS0001/21600-0001-Data.rda")
wave01 <- da21600.0001
wave01$wave <- 1
rm(da21600.0001)
...
```{r}
load("~/pCloudDrive/Git/Survival/AddHealth/ICPSR_21600/DS0005/21600-0005-Data.rda")
wave02 <- da21600.0005
wave02$wave <- 2
...
```{r}
load("~/pCloudDrive/Git/Survival/AddHealth/ICPSR_21600/DS0008/21600-0008-Data.rda")
wave03 <- da21600.0008
wave03$wave <- 3
...
```{r}
load("~/pCloudDrive/Git/Survival/AddHealth/ICPSR_21600/DS0022/21600-0022-Data.rda")
wave04 <- da21600.0022
wave04$wave <- 4
...
```{r}
load("~/pCloudDrive/Git/Survival/AddHealth/ICPSR_21600/DS0032/21600-0032-Data.rda")
wave05 <- da21600.0032
wave05$wave <- 5
